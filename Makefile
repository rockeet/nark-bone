...
bone_d_o := $(call objs,bone,d)
bone_r_o := $(call objs,bone,r)
bone_d := lib/libnark-bone-${COMPILER}-d${DLL_SUFFIX}
bone_r := lib/libnark-bone-${COMPILER}-r${DLL_SUFFIX}
static_bone_d := lib/libnark-bone-${COMPILER}-d.a
static_bone_r := lib/libnark-bone-${COMPILER}-r.a
...
bone: ${bone_d} ${bone_r} ${static_bone_d} ${static_bone_r}
...
${bone_d} ${bone_r} : LIBS += -lrt

${bone_d}:${bone_d_o}
${bone_r}:${bone_r_o}
${static_bone_d}:${bone_d_o}
${static_bone_r}:${bone_r_o}
